...
<tr bgcolor="#FDF5E7">
<td width="25%"><a href="admin.php?admincontent=cash_rallys&r_art=skr" target="_self">Statische Klickralley</a></td>
<td width="25%"><a href="admin.php?admincontent=cash_rallys&r_art=dkr" target="_self">Dynamische Klickralley</a></td>
<td width="25%"><a href="admin.php?admincontent=cash_rallys&r_art=sar" target="_self">Statische Aktivralley</a></td>
<td width="25%"><a href="admin.php?admincontent=cash_rallys&r_art=dar" target="_self">Dynamische Aktivralley</a></td>
</tr>
<tr bgcolor="#FDF5E7">
<td width="25%"><a href="admin.php?admincontent=cash_rallys&r_art=sbr" target="_self">Statische Bettelralley</a></td>
<td width="25%"><a href="admin.php?admincontent=cash_rallys&r_art=dbr" target="_self">Dynamische Bettelralley</a></td>
<td width="25%"><a href="admin.php?admincontent=cash_rallys&r_art=srr" target="_self">statische Refralley</a></td>
<td width="25%"></td>
</tr>
</table>
<br>
...
<td width="170" align="center"><b>Klicks/Punkte/Refs</b></td>
...
<%/if%>
<%if $r_art_start != 0 && $r_art_ende != 0%>
Diese Rally ist beendet und kann ausgewertet werden
<%/if%>
</b></td>
</tr>
</table>
<div align="center">
<form action="admin.php?admincontent=cash_rallys&r_art=<%$r_art%>" method="post">
<input type="Hidden" name="ralleyzahlen" value="<%$r_art%>">
<input type="Submit" name="auswerten" value="Diese Ralley auswerten!">
</form>
</div>
<%/if%>
