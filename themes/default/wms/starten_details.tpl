...
<%if $kamp_start%>
		...
		Dein neues Programm wurde eingebucht und gestartet, das Konto wurde mit <b><%$endpreis%> <%$waehrungsname%></b> belastet.<br>
		<br>
<%/if%>        
			...
			<input type="Hidden" name="send_kampstart" value="<%$send_kampstart%>">
			...
			<%else%>
				...
				<%else%>
					<%if $bannerpixe != 28080 and $bannerpixel != 2728%>
